...
public class Task3 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Get JSON from page source - the API returns JSON directly
            ...
            table.append(String.format("%-5s | %-20s | %-12s | %-12s%n", "№", "Дата/время", "Температура", "Осадки (мм)"));
            table.append("------|----------------------|--------------|--------------%n");
            ...
            for (int i = 0; i < times.size(); i++) {
                ...
                table.append(String.format("%-5d | %-20s | %-12.1f | %-12.2f%n", i + 1, time, temp, rainVal));
            }
